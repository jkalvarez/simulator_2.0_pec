...
%   generate_dataset([], [], "./gprMax_output/", "./permittivity_map_images/logit_scaled/")
%   generate_dataset([1 2 3 5 6 7 9 10 11 13 14 15 17 18 19], [4 8 12 16 20], "./gprMax_output/", "./permittivity_map_images/logit_scaled/");

%   pec water differentiation test
%   generate_dataset([1 2 3 13 14 15 17 18 19], [4 16 20], "./gprMax_output/", "./permittivity_map_images/logit_scaled/");
...
%% Loads testing simulation dataset
image_count = 1;
